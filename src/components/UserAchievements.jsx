...
const UserAchievements = () => {
  ...
  const getChapterNumberFromQuizId = (quizId) => {
    // Extract number from quizId like "chapter1", "chapter2", etc.
    ...
    <div className="flex flex-col py-4">
      ...
      <div className="quizzesCard mt-6 bg-[#1a1a1a] p-6 rounded-[20px] shadow-lg">
        ...
        {quizzes.map((quiz) => {
          ...
          const retakeUrl = chapterNumber ? `/quizzes/${chapterNumber}` : "/quizzes";
          ...
          return (
            ...
            >
              <div>
                ...
                <Link
                  to={retakeUrl}
                  className="mt-2 px-4 py-2 border-3 border-[#252525] text-sm rounded-md hover:bg-gray-700 flex items-center gap-2 transition"
                >
                  Retake Quiz
