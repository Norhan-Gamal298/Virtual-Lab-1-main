...
const PageOutro = () => {
    ...
    return (
        <div className='flex flex-col items-center pt-20 pb-[25rem] relative transition-all duration-300 '>
            ...
            <button onClick={handleDocsClick} className='bg-[#1F2937] hover:bg-[#374151] dark:bg-[#F9FAFB] text-[#ffffff] dark:text-[#121212] w-[150px] h-[50px] mt-[2rem] content-center poppins-semibold rounded-[11px] cursor-pointer z-1 tranistion-colors duration-200'>Get Started</button>
